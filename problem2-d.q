...
.aq.q0:{
 .aq.initQueryState[];
 aq__t0:.aq.initTable[trades;"trades";0b];
 aq__t0:?[aq__t0;();0b;((`stocksymbol);(`quantity);(`price))!({x^.aq.cd x} `stocksymbol;{x^.aq.cd x} `quantity;{x^.aq.cd x} `price)];
 aq__t0:.aq.distinct[aq__t0];
 aq__t0
 };
.aq.q0[]
