...
.aq.q0:{[]
 ...
 .aq.t1:![trade;();0b;c!( ;.aq.six) each c:(),{x^.aq.cd x}`price`stocksymbol];
 ...
 .aq.cd:() _ .aq.cd;
 .aq.t1:?[.aq.t1;();0b; .aq.acctgrps[ ; .aq.grpexpr](enlist[`stocksymbol]!enlist {x^.aq.cd x}`stocksymbol),(enlist[`unweighted_moving_avg]!enlist (mavg';10;{x^.aq.cd x}`price))];
 .aq.t1
 }
.aq.q0[]
